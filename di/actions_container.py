...
class ActionsContainer(
    ...
    get_exit_message = providers.Singleton(
        GetExitMessageAction,
    )
    get_help_message = providers.Singleton(
        GetHelpMessageAction,
    )
    get_unknown_command_message = providers.Singleton(
        GetUnknownCommandMessageAction,
    )
    get_welcome_message = providers.Singleton(
